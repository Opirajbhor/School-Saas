...
export const activities: Activity[] = [
  {
    ...
    actor: "Amara Okafor",
    initials: "AO",
    action: "published results for",
    target: "Grade 10 — Mid Term",
    time: "12m ago",
    kind: "result",
  },
  {
